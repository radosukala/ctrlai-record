 ...
 *
 * Share links checked on 22 September 2026 against each product's help pages and live share links.
 * Model names were checked on 22 September 2026, newest first. They change often, so the form also suggests
 * the names other contributors used in runs that passed verification (see recentModelLabels).
 * They are suggestions for the form, not a claim about any product.
 */
...
export const PRODUCTS: Product[] = [
  {
    ...
    modelHints: ['GPT-6 Pro', 'GPT-6 Astra', 'GPT-5.6 Sol', 'GPT-5.6 Luna'],
  },
  {
    ...
    modelHints: ['Fable 5.1', 'Opus 5', 'Sonnet 5', 'Haiku 4.5'],
  },
  {
    ...
    modelHints: ['3.8 Flash', '3.1 Pro', '3 Deep Think', '3.6 Flash', '3.5 Flash-Lite'],
  },
  {
    ...
    modelHints: ['Grok 4.7', 'Grok 4.6', 'Auto', 'Expert', 'Fast', 'Heavy'],
  },
  {
    ...
    modelHints: ['Smart', 'Think Deeper', 'Quick response'],
  },
  {
    ...
    modelHints: ['Muse Spark 1.3', 'Thinking', 'Instant'],
  },
  {
    ...
    modelHints: ['Best', 'Sonar 2', 'GPT-5.6 Terra', 'Claude Sonnet 5', 'Gemini 3.7 Flash', 'Grok 4.6', 'Kimi K3'],
  },
  {
    ...
    modelHints: ['Expert Mode', 'Instant Mode'],
  },
  {
    id: 'qwen', name: 'Qwen', maker: 'Alibaba', country: 'China',
    shareLinks: ['chat.qwen.ai/s/'],
    howToShare: 'Choose Share on the conversation and copy the link.',
    modelHints: ['Qwen3.8-Max', 'Qwen3.8-Omni-Flash', 'Qwen3.7-Plus'],
  },
  {
  ...
  },
  {
    ...
    modelHints: ['Mistral Medium 3.5', 'Chat mode', 'Work mode'],
  },
  {
